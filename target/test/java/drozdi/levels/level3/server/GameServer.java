...
import drozdi.levels.level3.console.error.ErrorManager;
import drozdi.net.*;
import lombok.Data;
import lombok.Getter;
import drozdi.levels.level3.client.PlayerMP;
import drozdi.levels.level3.console.ConsoleLogger;
import drozdi.levels.level3.console.error.GameError;
...
public class GameServer extends Thread{
  ...
  private void updateTick() {
    while (true){
      ...
      long sleepDuration = Math.max(10 - elapsedTime, 0);//100
      //      ServerSeparated.serverWindow.setTPS(1000.0/(double) (elapsedTime+sleepDuration));
      //System.out.println( ServerSeparated.serverWindow.getTPS() +"" +(1000.0/(double) (elapsedTime+sleepDuration)));
      try {
