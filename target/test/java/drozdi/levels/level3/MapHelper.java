...
public class MapHelper {
    ...
    private Set<drozdi.levels.level3.Bullet> playerShots = new HashSet<>();
    private Set<drozdi.levels.level3.Bullet> entityShots = new HashSet<>();
    ...
    private void loadMap(int mapNumber) {
        BufferedImage map = FileManager.loadResource("walls/maps/map" + mapNumber + ".bmp");
        loadMap(map);
    }**/
    public void loadMap() {
