...
public class Story0 extends JPanel {
	...
	public Story0(drozdi.game.Window window, String text) {
		this.window = window;
		window.defineWindow();
		base(text);
	}
	...
	public void setUpDownBar() {
		...
		back.setIcon(drozdi.game.Window.resizeImage(FileManager.loadImageIcon(quit),back.getWidth(), back.getHeight()));
		back.setBorder(null);
